...
public interface PhoneInterface {
	...
	/**
	 * Time in ms between two event on touchscreen are recorded.
	 * That's also time to wait for playing a second event on touchscreen.
	 */
//	public static final int INTERVAL_TIME_BETWEEN_TOUCHSCREEN_EVENT = 70;
	 ...
	 * 
	 * @param path. A list of coordinate which approximate the path of the drag n drop.
	 * 
 ...
 */
	 ...
	 *            is negative, free totally the available space. <br/> <code>
	 ...
	 * @throws PhoneException 
	 */
	//public void registry(String base, String value, String string) throws PhoneException;
	 ...
	 * @param Msg Message
	 * @param EmailDest Email Dest
	 * @param NameDest Name Dest
	 * @param NameSrc Name Source
	 * @param EmailSrc Email Source
	 * @throws PhoneException 
	 */
	
	public void sendEmail(String Subject,String Msg,String EmailDest,String NameDest,String NameSrc,String EmailSrc) throws PhoneException;
	
	
	/**
	 * Set Sleep mode on/off, to enable/disable phone screen saver. 
	 * 
	 * @param ispm true to set pm on
	 */
	...
	/*****
	 * setvariable
	 * only used when application is embedded on the phone
	 * such on nokia S60
	 * 
	 * @param testFile testFile
	 * @param hopperTest TODO
	 * @throws PhoneException 
	 * 
	 * 
	 */
	...
	public boolean startRandomTest(String hopperTest,String outputDir,ResultLogger mainLogger, Hashtable<String,String> hopperTestParam) throws PhoneException;
	 ...
	 * Set FlightMode
	 * 
	 * @param On : true Enable flight mode / false disable flight mode
	 ...
	 * @param key name of Measurement in config file xml
	 */
...
//	public String getphoneStatusMsg();
	...
	// Get the list of process/applications that can be monitored (cpu/memory) during a test
	public String[]  getMonitorList();
	
	/**
	 * Get list of keys
	 * 
	 * The key of the map is name of key (used in keyPress, keyDown, or anywhere else)
	 * The value of the map, is the Ressource Location of the icon.
	 */
	 ...
	 * ANDROID_NAVIGATION are the 5 key on HTC G1 by example.
	 * PHONE are number pad for mainly phone.
	 * QWERTY is a qwerty keyboard.
	 * @return Possibles values are 9KEY_NAVIGATION, ANDROID_NAVIGATION, PHONE, QWERTY or null element. 
	 */
	 ...
	 * implement this method for all sampled measurements
