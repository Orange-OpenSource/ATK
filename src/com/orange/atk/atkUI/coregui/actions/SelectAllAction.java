 ...
 * 
 * ------------------------------------------------------------------
 * File Name   : SelectAllAction.java
 *
 * Created     : 09/05/2007
 ...
 * @since JDK5.0
 */
public class SelectAllAction extends MatosAbstractAction {

	private static final long serialVersionUID = 1L;

	public SelectAllAction(String name, Icon icon, String shortDescription) {
	...
	public void actionPerformed(ActionEvent e) {
		for (AnalysisGUICommon guiCommon : MatosGUI.analysisPlugins	) {
			guiCommon.getCheckListTable().getTable().selectAll();
		}
	}
