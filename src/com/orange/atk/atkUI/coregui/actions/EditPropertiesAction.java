 ...
 * 
 * ------------------------------------------------------------------
 * File Name   : EditPropertiesAction.java
 *
 * Created     : 09/05/2007
 ...
 * @since JDK5.0
 */
public class EditPropertiesAction extends MatosAbstractAction {

	private static final long serialVersionUID = 1L;

	public EditPropertiesAction(String name, Icon icon, String shortDescription) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		guiCommonSelected.editSelectedStepProperties();
	}
