 ...
 * 
 * ------------------------------------------------------------------
 * File Name   : AnalyseAllCurrentTabAction.java
 *
 * Created     : 09/05/2007
 ...
 * @since JDK5.0
 */
public class AnalyseAllCurrentTabAction extends MatosAbstractAction {

	private static final long serialVersionUID = 1L;

	public AnalyseAllCurrentTabAction(String name, Icon icon, String shortDescription) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		new AnalyseTask(CoreGUIPlugin.mainFrame.statusBar, matosGui.getSelectedAnalysisPane().getCheckListTable(), true);
	}
