 ...
 * @since JDK5.0
 */
public class SaveAsAction extends MatosAbstractAction {

	private static final long serialVersionUID = 1L;

	private String lastChkLstFilePath = null;

	public SaveAsAction(String name, Icon icon, String shortDescription) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		int returnVal = fileChooser.showDialog(matosGui, "Save check-list as...");
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				Campaign.save(matosGui.getCheckListFileName(), camp);
			} catch (Alert a) {
