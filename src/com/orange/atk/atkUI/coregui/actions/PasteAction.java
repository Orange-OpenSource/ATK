 ...
 * @since JDK5.0
 */
public class PasteAction extends MatosAbstractAction {

	private static final long serialVersionUID = 1L;

	public PasteAction(String name, Icon icon, String shortDescription) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		guiCommonSelected.getCheckListTable().pasteUnder();
	}
