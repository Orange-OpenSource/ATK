...
public class FileUtilities {
	...
	/**
	 * Copy a source html file into a destination file,
	 * patching the style sheet on the fly for the given one.
	 * @param in source html file
	 * @param out destination file
	 * @param newStyleSheetPath the new css style sheet absolute path
	 * @throws Exception
	 */
	...
	/**
	 * Replace color name by color value from file 'in' to file 'out'.
	 * In order to resolve form a file, conciders copying it in a temp file before:
	 * <code>
	 ...
	 * @param in source html file
	 * @param out destination file
	 * @param colorName the new name of the color (ex: orange)
	 * @param colorValue the value to use (ex: #FF6A0)
	 * @throws IOException
	 */
	public static void resolveHTMLColor(File in, File out, String colorName, String colorValue) throws IOException {
