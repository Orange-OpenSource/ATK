...
/**
 * Represents the different actions which could be specified in the MAP language: let (assignment),
 * foreach (repetitive construct), if (conditional construct) and report (reporting)
 * @author penaulau
 * @since JDK5.0
 */
public class Action extends Inline implements Serializable, Visitable {
