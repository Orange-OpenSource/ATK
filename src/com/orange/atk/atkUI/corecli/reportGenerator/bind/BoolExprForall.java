...
/**
 * Represents an element of the MAP language that allows knowing if all elements
 * of the set defined in the <code>In</code> clause that verifies the given boolean expression.
 * @author penaulau
 * @since JDK5.0
 */
public class BoolExprForall extends BoolExpr implements Visitable, Serializable {
