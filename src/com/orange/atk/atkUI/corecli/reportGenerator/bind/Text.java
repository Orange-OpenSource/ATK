...
/**
 * Represents a node text of the HTML result stream.
 * @author penaulau
 * @since JDK5.0
 */
public class Text extends Inline implements Serializable, Visitable {
	 ...
	 * @param content New value of property <code>content</code>.
	 */
