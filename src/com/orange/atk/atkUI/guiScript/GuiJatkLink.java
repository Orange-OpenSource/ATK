 ...
 * @since JDK5.0
 */
public class GuiJatkLink {

	/** The plugin id, as defined in the plugin.xml file*/
	public static final String PLUGIN_ID = "guijatk";

	private static JatkGUI flashGUI = null;

	/**
	 * Retrieves the instance of FlashGUI plugin
	 * @return the instance of FlashGUI plugin
	 */
	public static JatkGUI getFlashGUI() {
		if (flashGUI == null) {
			for (IGUICommon guiCommon : CoreGUIPlugin.guiCommons) {
				if (guiCommon instanceof JatkGUI) {
					flashGUI = (JatkGUI)guiCommon;
					break;
				}
			}
		}
