...
public class JatkCheckListTable extends CheckListTable {
	...
	private JPopupMenu createTablePopUp() {
		...
		popup.add(JatkGUIAction.SETSCREENSHOTREFERENCEDIR.getAsMenuItem("Set Reference Screenshots"));
	...
	public void addRow(Step step, int rowNumberInGUI, boolean selectIt,	boolean checkPreviousResults) {
		...
		if (checkPreviousResults) {
			...
			//				JatkStepAnalysisResult rs = (JatkStepAnalysisResult)arManager.getPreviousAnalysisResult(flashStep);
			//				if (rs!=null) {
			//					results.add(rs);
			//				}
			//			}
