...
public enum JatkGUIAction {
	...
	//LOOP ("MixScript", new CheckCnxGUIJatkAction("MixScript", new ImageIcon(CoreGUIPlugin.getIconURL("tango/cache.png")), "Mix Script")),

	
	ABOUT ("about", new AboutGUIJatkAction("about", new ImageIcon(CoreGUIPlugin.getIconURL("tango/messagebox_info.png")), "About the application."));
