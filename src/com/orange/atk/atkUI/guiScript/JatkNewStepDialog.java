 ...
 * 
 * ------------------------------------------------------------------
 * File Name   : JatkNewStepDialog.java
 *
 * Created     : 28/05/2007
 ...
 * @since JDK5.0
 */
public class JatkNewStepDialog extends JatkStepDialog {
	...
	protected void action() {
		verifyAndInitialize();
		if (!fileError){
			JatkStep cmdLine = new JatkStep(this.flashURI, this.flashFile);
