 ...
 * 
 * ------------------------------------------------------------------
 * File Name   : MixScriptNewStepDialog.java
 *
 * Created     : 28/05/2007
 ...
 * @since JDK5.0
 */
public class MixScriptNewStepDialog extends MixScriptStepDialog {
	...
	protected void action() {
		verifyAndInitialize();
		if (!fileError){
			MixScriptStep cmdLine = new MixScriptStep(flashURI, this.flashFile );
