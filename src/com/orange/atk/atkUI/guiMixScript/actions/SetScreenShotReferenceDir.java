...
import com.orange.atk.atkUI.guiMixScript.MixScriptCheckListTable;
...
public class SetScreenShotReferenceDir extends MatosAbstractAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		JTable _table = mixScriptGUI.getCheckListTable().getTable();
	...
	//	String testname =(String) _table.getModel().getValueAt(row, MixScriptCheckListTable.COLUMN_TESTNAME);
		...
		if(file.exists())
		{
			try {
				...
				String ligne;
				// TODO what is the cursor meant to do ?
				//long cursor=0;
				String refPath=null;
				String contenu="";
