 ...
 * 
 * ------------------------------------------------------------------
 * File Name   : AboutGUIMixScriptAction.java
 *
 * Created     : 28/05/2007
 ...
 * @since JDK5.0
 */
public class AboutGUIMixScriptAction extends MatosAbstractAction {
	 ...
	 */
	public AboutGUIMixScriptAction(String name, Icon icon, String shortDescription) {
