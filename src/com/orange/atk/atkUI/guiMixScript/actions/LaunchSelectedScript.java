 ...
 * 
 * ------------------------------------------------------------------
 * File Name   : LaunchSelectedScript.java
 *
 * Created     : 28/05/2007
...
public class LaunchSelectedScript extends MatosAbstractAction {
	...
	public void actionPerformed(ActionEvent e) {
		MixScriptGUI mixScriptGUI = GuiMixScriptLink.getFlashGUI();
		...
		//Mix Script
		CheckListTable checkListTable = mixScriptGUI.getCheckListTable();
	    ...
	    Campaign.setExecuteloop(true);	
		new AnalyseTask(CoreGUIPlugin.mainFrame.statusBar, mixScriptGUI.getCheckListTable(), false);
		}
