...
public class UiAutomatorViewer extends JFrame {
	...
	public UiAutomatorViewer() {
		...
		jbtOpenFolder=new JButton(new ImageIcon(CoreGUIPlugin.getIconURL("icons/rec_open_folder.png")));
		...
		jbtScreenshot=new JButton(new ImageIcon(CoreGUIPlugin.getIconURL("icons/rec_screenshot.png")));
		...
		jbtExpandAll=new JButton(new ImageIcon(CoreGUIPlugin.getIconURL("icons/rec_expandall.png")));
