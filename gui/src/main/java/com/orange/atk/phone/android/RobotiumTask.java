...
public class RobotiumTask {
	...
	public void sendCommandToExecuteToSolo(Object [] commands) throws PhoneException {
		...
		if(!Start_Solo) {
			...
			String Scommand="am instrument -w com.orange.atk.solotestrunner/android.test.InstrumentationTestRunner";
	...
	private void pushATKSoloTest() throws PhoneException {
		...
		try {
			if(checkRobotium("com.orange.atk.solotestrunner")==0) {
				String result = adevice.uninstallPackage("com.orange.atk.solotestrunner");
				if(result!=null){
