...
public class RecorderFrame extends JFrame implements ErrorListener  {
	...
	public RecorderFrame(ScriptController sc) throws HeadlessException {
		...
		jbtRecord=new JButton(new ImageIcon(CoreGUIPlugin.getIconURL("icons/rec_record.png")));
		//jbtRecord=new JButton(new ImageIcon(CoreGUIPlugin.getIconURL("tango-l/rec_record.png")));
		...
		jbtStop= new JButton(new ImageIcon(CoreGUIPlugin.getIconURL("icons/rec_stop.png")));
		...
		jbtPlay= new JButton(new ImageIcon(CoreGUIPlugin.getIconURL("icons/rec_noatunplay.png")));
		...
		jbtscreenshot= new JButton(new ImageIcon(CoreGUIPlugin.getIconURL("icons/rec_camera.png")));
		...
		jbtGetViewsFromRobotium = new JButton(new ImageIcon(CoreGUIPlugin.getIconURL("icons/rec_screenshot.png")));
		...
		jtp.add(jsPanel);
		jtp.setIconAt(jtp.indexOfComponent(jsPanel),new ImageIcon(CoreGUIPlugin.getIconURL("icons/rec_script.png")));
