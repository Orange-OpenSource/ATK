...
public class CoreGUIPlugin {
	...
	public static URL getIconURL(String iconFileName) {
		URL iconURL = CoreGUIPlugin.class.getClassLoader().getResource(iconFileName);;
		if(iconURL == null){
			iconURL = CoreGUIPlugin.class.getClassLoader().getResource("icons/messagebox_warning.png");
		}
		return iconURL;
	}
