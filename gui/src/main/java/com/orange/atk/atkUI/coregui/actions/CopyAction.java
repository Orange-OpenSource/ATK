 ...
 * @since JDK5.0
 */
public class CopyAction extends MatosAbstractAction {

	private static final long serialVersionUID = 1L;

	public CopyAction(String name, Icon icon, String shortDescription) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		guiCommonSelected.getCheckListTable().copySelection();
	}
