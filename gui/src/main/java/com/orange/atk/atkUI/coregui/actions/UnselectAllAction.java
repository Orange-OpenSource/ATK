 ...
 * 
 * ------------------------------------------------------------------
 * File Name   : UnselectAllAction.java
 *
 * Created     : 09/05/2007
 ...
 * @since JDK5.0
 */
public class UnselectAllAction extends MatosAbstractAction {

	private static final long serialVersionUID = 1L;

	public UnselectAllAction(String name, Icon icon, String shortDescription) {
	...
	public void actionPerformed(ActionEvent e) {
		for (AnalysisGUICommon guiCommon : MatosGUI.analysisPlugins	) {
			guiCommon.getCheckListTable().getTable().clearSelection();
		}
	}
