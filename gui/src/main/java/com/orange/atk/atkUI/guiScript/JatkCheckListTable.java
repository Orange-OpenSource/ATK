...
public class JatkCheckListTable extends CheckListTable {
	...
	public class GeneralRenderer extends JLabel implements TableCellRenderer {
		...
		public GeneralRenderer() {
			...
			java.net.URL passedURL = CoreGUIPlugin.getIconURL("icons/apply.png");
			java.net.URL failedURL = CoreGUIPlugin.getIconURL("icons/messagebox_warning.png");
			java.net.URL skippedURL = CoreGUIPlugin.getIconURL("icons/cache.png");
