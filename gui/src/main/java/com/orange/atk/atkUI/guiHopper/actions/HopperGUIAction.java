...
public enum HopperGUIAction {
	...
	ADDFLASHANIMATION ("AddScriptAction", new AddScriptAction("AddScriptAction", new ImageIcon(CoreGUIPlugin.getIconURL("icons/add.png")), "Add a Hopper Test to the current check-list.")),

	ANALYSEALLFLASH ("LaunchAllScript", new LaunchAllScript("LaunchAllScript", new ImageIcon(CoreGUIPlugin.getIconURL("icons/noatunplay.png")), "Launch all scripts of the check-list.")),

	ANALYSESELECTIONFLASH ("LaunchSelectedScript", new LaunchSelectedScript("LaunchSelectedScript", new ImageIcon(CoreGUIPlugin.getIconURL("icons/play-selection.png")), "Launch selected Script of the check-list.")),

	STOPSCRIPT ("StopScript", new StopScript("StopScript", new ImageIcon(CoreGUIPlugin.getIconURL("icons/noatunstop.png")), "Stop the current task.")),

	ABOUT ("about", new AboutguihopperAction("about", new ImageIcon(CoreGUIPlugin.getIconURL("icons/messagebox_info.png")), "About the application."));
