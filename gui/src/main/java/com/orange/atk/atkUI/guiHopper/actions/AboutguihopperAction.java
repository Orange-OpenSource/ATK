 ...
 * 
 * ------------------------------------------------------------------
 * File Name   : AboutguihopperAction.java
 *
 * Created     : 28/05/2007
 ...
 * @since JDK5.0
 */
public class AboutguihopperAction extends MatosAbstractAction {
	 ...
	 */
	public AboutguihopperAction(String name, Icon icon, String shortDescription) {
