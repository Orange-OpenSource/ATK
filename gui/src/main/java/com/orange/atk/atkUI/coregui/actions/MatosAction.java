...
public enum MatosAction {
	NEWCHECKLIST("new", new NewCheckListAction("new", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/filenew.png")), "Create a new check-list")),

	OPEN("open", new OpenAction("open", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/folder-green.png")), "Open a check-list.")),

	SAVEALLALL("saveAllAll", new SaveAction("saveAllAll", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/filesave.png")), "Save the current check-list.")),

	SAVEAS("saveAs", new SaveAsAction("saveAs", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/filesaveas.png")), "Save the current check-list as...")),
	...
	SAVESELECTIONAS("saveSelectionAs", new SaveSelectionAsAction("saveSelectionAs", null,
			...
			"openRecorder", new ImageIcon(CoreGUIPlugin.getIconURL("icons/record.png")),
			"Open the script recorder")),

	MONITOR("monitor", new MonitorAction("monitor", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/graph.png")),
	...
	ADDDIR("addDir", new AddDirectoryAction("addDir", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/add-dir.png")),
	...
	VIEWREPORT("viewReport", new ViewReportAction("viewReport", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/view-rep.png")),
	...
	ANALYSESELECTIONCURRENTTAB("analyseSelection", new AnalyseSelectionCurrentTabAction(
			"analyseSelection",
			new ImageIcon(CoreGUIPlugin.getIconURL("icons/play-selection.png")),
	...
	ANALYSEALLCURRENTTAB("analyseAll", new AnalyseAllCurrentTabAction("analyseAll", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/noatunplay.png")),
	...
	EXIT("exit", new ExitAction("exit", new ImageIcon(CoreGUIPlugin.getIconURL("icons/exit.png")),
			"Quit the application.")),

	ABOUT("about", new AboutAction("about", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/messagebox_info.png")), "About ATK")),

	USERGUIDE("User Guide", new HelpAction("Sony Ericsson", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/messagebox_info.png")), "ATK User Guide", "index.html")),

	ADDTASK("add script", new AddTaskAction("Add a task", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/add.png")), "Add a task to the current check-list.")),
	...
	STOPTASK("StopScript", new StopScript("StopScript", new ImageIcon(
			CoreGUIPlugin.getIconURL("icons/noatunstop.png")), "Stop the current task.")),
