...
public class JPhoneStatusButton extends JButton implements DeviceDetectionListener {
	...
	private void setNoPhoneConnectedStatus() {
		setIcon(new ImageIcon(CoreGUIPlugin.getIconURL("icons/nophone.png")));
		setText(NO_PHONE);
		repaint();		
	}
	
	private void setPhoneNotAvailableStatus() {
		setIcon(new ImageIcon(CoreGUIPlugin.getIconURL("icons/phonenotready.png")));
		setText(phone.getName()+" ");
		repaint();		
	}

	private void setPhoneConnectedStatus() {
		setIcon(new ImageIcon(CoreGUIPlugin.getIconURL("icons/phone.png")));
		setText(phone.getName()+" ");
		repaint();		
	}

    private void setPhoneUnconfiguredStatus() {
        setIcon(new ImageIcon(CoreGUIPlugin.getIconURL("icons/phonenotconfigured.png")));
        setText(phone.getName()+" ");
        repaint();
    }
