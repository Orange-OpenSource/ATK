 ...
 * 
 * ------------------------------------------------------------------
 * File Name   : AnalyseAllAllTabAction.java
 *
 * Created     : 09/05/2007
 ...
 * @since JDK5.0
 */
public class AnalyseAllAllTabAction extends MatosAbstractAction {

	private static final long serialVersionUID = 1L;

	public AnalyseAllAllTabAction(String name, Icon icon, String shortDescription) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		for (AnalysisGUICommon analysisGUI : MatosGUI.analysisPlugins) {
			AnalyseTask at = new AnalyseTask(CoreGUIPlugin.mainFrame.statusBar, analysisGUI.getCheckListTable(), true);
